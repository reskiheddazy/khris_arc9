...
SWEP.Description = [[A versatile and reliable battle rifle, widely used in various combat scenarios.]]
...
--// 2. MODELS & VIEW //---------------------
SWEP.ViewModel = "models/khris_2026/arccw_khris_fnfal.mdl"
...
SWEP.ShootSound = {"weapons/fnfal_ins/fire1.wav", "weapons/fnfal_ins/fire2.wav", "weapons/fnfal_ins/fire3.wav"}
SWEP.ShootSoundSilenced = {"weapons/fnfal_ins/firesil1.wav", "weapons/fnfal_ins/firesil2.wav", "weapons/fnfal_ins/firesil3.wav"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/fnfal_ins/magout.wav", t = 0.48},
            {s = "weapons/fnfal_ins/magrattle.wav", t = 0.9},
            {s = "weapons/fnfal_ins/magin.wav", t = 1.2},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "weapons/fnfal_ins/magout.wav", t = 0.21},
            {s = "weapons/fnfal_ins/magrattle.wav", t = 1.5},
            {s = "weapons/fnfal_ins/magin.wav", t = 1.68},
            {s = "weapons/fnfal_ins/boltrelease.wav", t = 1.95},
        }
    },
    ["draw"] = {
        Source = "draw",
