...
SWEP.Description = [[A compact Russian submachine gun designed for close-quarters combat.]]
...
--// 2. MODELS & VIEW //---------------------
SWEP.ViewModel = "models/khris_2026/arccw_khris_sr2m.mdl"
...
SWEP.ShootSound = {"weapons/sr2/fire1.wav", "weapons/sr2/fire2.wav", "weapons/sr2/fire3.wav"}
SWEP.ShootSoundSilenced = {"weapons/sr2/firesup1.wav", "weapons/sr2/firesup2.wav", "weapons/sr2/firesup3.wav"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/sr2/magout.wav", t = 0.48},
            {s = "weapons/sr2/magin.wav", t = 0.95},
            {s = "weapons/sr2/magin2.wav", t = 1.1},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "weapons/sr2/magout.wav", t = 0.19},
            {s = "weapons/sr2/magin.wav", t = 1},
            {s = "weapons/sr2/magin2.wav", t = 1.15},
            {s = "weapons/sr2/boltback2.wav", t = 1.7},
            {s = "weapons/sr2/boltfwd2.wav", t = 1.8},
        }
    },
    ["draw"] = {
        Source = "draw",
...
SWEP.Attachments = {
    {
        ...
        Bone = "weapon",
        Pos = Vector(0, -2.15, -3.3),
        Ang = Angle(90, -90, 0),
    },
    {
        PrintName = "Grip",
        Category = {"khris_grip_sr2"},
        Bone = "weapon",
        Pos = Vector(-0, -0.5, 5.2),
        Ang = Angle(90, 0, -90),
    },
    {
        PrintName = "Muzzle",
