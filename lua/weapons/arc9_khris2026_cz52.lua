...
SWEP.Class = "Pistol"
SWEP.Description = [[A Czechoslovakian semi-automatic pistol designed for military use. It features a unique roller-locked mechanism and is chambered in 7.62×25mm Tokarev.]]
...
--// 2. MODELS & VIEW //---------------------
SWEP.ViewModel = "models/khris_2026/arccw_khris_cz52.mdl"
...
SWEP.ShootSound = {"weapons/khrcz52/m9_fp.wav"}
SWEP.ShootSoundSilenced = {"weapons/khrcz52/m9_suppressed_fp.wav"}
...
SWEP.ActivePos = Vector(-0.25, -1.5, -0.45)
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "weapons/khrmakarov/makarov_magrelease.wav", t = 0.40},
            {s = "weapons/khrmakarov/makarov_magout.wav", t = 0.5},
            {s = "weapons/khrmakarov/makarov_magin.wav", t = 0.85},
            {s = "weapons/khrmakarov/makarov_maghit.wav", t = 0.98},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        EventTable = {
            {s = "weapons/khrmakarov/makarov_magrelease.wav", t = 0.10},
            {s = "weapons/khrmakarov/makarov_magout.wav", t = 0.14},
            {s = "weapons/khrmakarov/makarov_magin.wav", t = 1},
            {s = "weapons/khrmakarov/makarov_maghit.wav", t = 1.15},
            {s = "weapons/khrmakarov/makarov_boltback.wav", t = 1.7},
            {s = "weapons/khrmakarov/makarov_boltrelease.wav", t = 1.85},
        }
    },
    ["draw"] = {
        Source = "draw",
