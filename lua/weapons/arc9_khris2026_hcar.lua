...
SWEP.Description = [[A modernized version of the .30-6 Caliber styled of weapons. It is a battle rifle that is designed for long-range engagements, and it excels at medium to long-range combat.]]
...
--// 2. MODELS & VIEW //---------------------
SWEP.ViewModel = "models/khris_2026/arccw_khris_hcar.mdl"
...
SWEP.ShootSound = {"weapons/bfhardline_hcar/fire1.wav", "weapons/bfhardline_hcar/fire2.wav", "weapons/bfhardline_hcar/fire3.wav"}
SWEP.ShootSoundSilenced = {"weapons/bfhardline_hcar/firesil1.wav", "weapons/bfhardline_hcar/firesil2.wav", "weapons/bfhardline_hcar/firesil3.wav"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/bfhardline_hcar/clipout.wav", t = 0.35},
            {s = "weapons/bfhardline_hcar/clipin.wav", t = 1.45},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "weapons/bfhardline_hcar/clipout.wav", t = 0.35},
            {s = "weapons/bfhardline_hcar/clipin.wav", t = 1.45},
            {s = "weapons/aek/boltpull.wav", t = 2.25},
            {s = "weapons/bfhardline_hcar/boltslap.wav", t = 2.5},
        }
    },
    ["draw"] = {
        Source = "draw",
...
SWEP.Attachments = {
    {
        ...
        Bone = "weapon",
        Pos = Vector(-0, -2.9, -3.45), 
        Ang = Angle(90, -90, 0),
        InstalledElements = {"toprail"},
    },
    {
        PrintName = "Muzzle",
        Category = {"khris_muzzle_ar"},
        Bone = "weapon",
        Pos = Vector(-0, -1.45, 21),
        Ang = Angle(180, 0, -90),
    },
}