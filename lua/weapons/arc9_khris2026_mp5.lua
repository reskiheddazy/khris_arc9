...
SWEP.Description = [[A compact German submachine gun designed for close-quarters combat.]]
...
--// 2. MODELS & VIEW //---------------------
SWEP.ViewModel = "models/khris_2026/arccw_khris_mp5.mdl"
...
SWEP.ShootSound = {"weapons/kp5a4/fire1.wav", "weapons/kp5a4/fire2.wav", "weapons/kp5a4/fire3.wav"}
SWEP.ShootSoundSilenced = {"weapons/kp5a4/firesil1.wav", "weapons/kp5a4/firesil2.wav", "weapons/kp5a4/firesil3.wav"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/mp5/magout.wav", t = 0.45},
            { s = "weapons/mp5/magin1.wav", t = 1.12},
            { s = "weapons/mp5/magin2.wav", t = 1.25},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
            {s = "weapons/mp5/boltback.wav", t = 0.12},
            {s = "weapons/mp5/magout.wav", t = 0.80},
            {s = "weapons/mp5/magin1.wav", t = 1.65},
            {s = "weapons/mp5/magin2.wav", t = 1.78},
            {s = "weapons/mp5/boltslap.wav", t = 2.33},
        }
    },
    ["draw"] = {
        Source = "draw",
